...
def get_ds(config):
    ...
    print(f"Max length for src sentence: {max_len_src}")
    print(f"Max length for tgt sentence: {max_len_tgt}")
...
def get_model(config, vocab_src_len, vocab_tgt_len):
    # if the model is too big then reduce the number of heads or layers
